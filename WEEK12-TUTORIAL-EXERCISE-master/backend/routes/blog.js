...
const blogOwner = async (req, res, next) => {
  // ถ้าเป็น admin ให้ผ่านเลย แก้ไขได้ของทุกคน
  if (req.user.role === 'admin') {
    return next()
  }
  //[[blog]] ได้เป็น obj ออกมาเลย
...
// ได้ id blog ต้อง isLoggedIn เพื่อเช็คว่ามีการ login แล้ว ค่อยเช็คว่าเป็น blog ของเรารึป่าว

...
export default {
  ...
  methods: {
    ...
    addComment() {
      axios
        .post(`http://localhost:3001/${this.blog.id}/comments`, {
    ...
    saveEditComment(commentId, index) {
      axios
        .put(`http://localhost:3001/comments/${commentId}`, {
    ...
    addLikeComment(commentId) {
      axios
        .put(`http://localhost:3001/comments/addlike/${commentId}`)
        .then((response) => {
    ...
    deleteBlog() {
      ...
      if (result) {
        axios
          .delete(`http://localhost:3001/blogs/${this.blog.id}`)
          .then((response) => {
            this.$router.push("/");
          })
          .catch((error) => {
